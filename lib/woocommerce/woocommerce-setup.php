 ...
 *
 * This file adds the required WooCommerce setup functions to the ChurchPress Genesis Starter Theme.
 *
...
function genesis_sample_products_match_height() {
	...
	wp_enqueue_script(
		'cp-genesis-starter-match-height',
...
function genesis_sample_woocommerce_pagination( $args ) {
	...
	$args['prev_text'] = sprintf( '&laquo; %s', __( 'Previous Page', 'cp-genesis-starter' ) );
	$args['next_text'] = sprintf( '%s &raquo;', __( 'Next Page', 'cp-genesis-starter' ) );
