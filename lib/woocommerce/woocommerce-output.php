 ...
 *
 * This file adds the WooCommerce styles and the Customizer additions for WooCommerce to the ChurchPress Genesis Starter Theme.
 *
...
function genesis_sample_woocommerce_styles( $enqueue_styles ) {
	...
	$enqueue_styles['cp-genesis-starter-woocommerce-styles'] = array(
		'src'     => get_stylesheet_directory_uri() . '/lib/woocommerce/cp-genesis-starter-woocommerce.css',
		'deps'    => '',
...
function genesis_sample_woocommerce_css() {
	...
	if ( $woo_css ) {
		wp_add_inline_style( 'cp-genesis-starter-woocommerce-styles', $woo_css );
	}
